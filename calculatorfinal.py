...
if __name__ == "__main__":
	...
	root= Button(gui, text='%', fg='black', bg='white',command=lambda: press('%'), height=1, width=7)	
	root.grid(row=6, column=1)
	exclamatory= Button(gui, text='!', fg='black', bg='white',command=lambda: press('!'), height=1, width=7)	
	exclamatory.grid(row=6, column=2)
